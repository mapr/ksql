...
CREATE OR REPLACE TABLE a (id INT PRIMARY KEY, col1 INT, col2 INT) WITH (kafka_topic='/s:a', value_format='JSON');
...
CREATE STREAM a (id INT KEY, col1 INT, col2 INT) WITH (kafka_topic='/s:a', value_format='JSON');
CREATE OR REPLACE STREAM a (id INT KEY, col1 INT) WITH (kafka_topic='/s:a', value_format='JSON');
...
CREATE TABLE a (id INT PRIMARY KEY, col1 INT, col2 INT) WITH (kafka_topic='/s:a', value_format='JSON');
CREATE OR REPLACE TABLE a (id INT PRIMARY KEY, col1 INT) WITH (kafka_topic='/s:a', value_format='JSON');
