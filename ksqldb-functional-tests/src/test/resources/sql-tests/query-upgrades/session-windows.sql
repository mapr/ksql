...
----------------------------------------------------------------------------------------------------
CREATE STREAM TEST (ID BIGINT KEY, VALUE bigint) WITH (kafka_topic='/s:test_topic', value_format='DELIMITED');
...
----------------------------------------------------------------------------------------------------
CREATE STREAM INPUT (A DECIMAL(4,2)) WITH (kafka_topic='/s:INPUT', format='JSON');
