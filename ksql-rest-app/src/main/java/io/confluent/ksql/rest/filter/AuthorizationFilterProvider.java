...
import io.confluent.ksql.rest.util.UnixUserIdUtils;
...
public final class AuthorizationFilterProvider {
  ...
  public static AuthorizationFilter configure(KsqlRestConfig ksqlRestConfig) {
    ...
    final String internalTopic = getConfiguredAuxiliaryTopic(ksqlRestConfig);
  ...
  private static String getConfiguredAuxiliaryTopic(KsqlRestConfig ksqlRestConfig) {
